...
FRIEND1_NAME = "Zair aka dumb kid" # change this to a friend's name!
FRIEND2_NAME = "old fat man" # change this to another friend's name!
...
def generate_map()
# This function makes map for current room,
# using room data, scenery data and prop data.

global room_map, room_height, room_width, room_name, hazard_map
...
# Add any middle lines of room map (wall, floor to fill width, wall).
